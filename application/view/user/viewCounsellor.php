        ...
        <table class="table table-striped">
            ...
            <?php foreach ($users as $user) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo URL . 'user/deleteCounsellor/' . htmlspecialchars($user->user_id, ENT_QUOTES, 'UTF-8'); ?>">delete</a></td>
                    <td><a href="<?php echo URL . 'user/editCounsellor/' . htmlspecialchars($user->user_id, ENT_QUOTES, 'UTF-8'); ?>">edit</a></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
